...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/home/ripper/compile/proton/bin/aarch64-linux-gnu- --gcc-toolchain=/home/ripper/compile/proton -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
